...
<section class="shipping ">
  <br><br>
    <div class="container">
      <h2 class="hh3 pt-5">Products ready for shipping</h2>
        <table class="t1 table table-dark table-hover">
            <th class="heading1">
                <td class="">Shipping ID</td>
                <td class="">Address</td>
            ...
            $str="select * from shipping";
            $result=$db->query($str);
            while($row = mysqli_fetch_assoc($result)){
                shippingElement($row['shipping_id'],$row['address'],$row['phone_number'],$row['cart_id']);
            }
            ?>
