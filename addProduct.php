...
<section class="sec_cont py-5">
    <div class="container">
        ...
        <div class="contactForm">
            <h2>Add a product</h2>
            <div class="formBox">
                <form action="upload.php" method="post" name="form" class="formBox" enctype="multipart/form-data">
                    ...
                    <span> <h4 style="font-weight:normal "  >Category :  </h4> </span> </pr>
                    <div class="radios" style="alignment: left">

                        <input type="radio" required  name="Category" value="2" id="Women"  ">
                        <label for="Women" style="font-size: 12px">Women</label>
                        <input type="radio" required name="Category" value="1" id="Men">
                        <label for="Men"style="font-size: 12px">Men</label>
                        <input type="radio" required name="Category" value="3" id="Accessories">
                        <label for="Accessories"style="font-size: 12px">Accessories</label>
                        <input type="radio"  required name="Category" value="5" id="Watches">
                        <label for="Watches"style="font-size: 12px">Watches</label>
                        <input type="radio"  required name="Category" value="4" id="Shoes">
                        <label for="Shoes"style="font-size: 12px">Shoes</label>
