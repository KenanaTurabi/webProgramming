...
<html lang="en">
  <head>
    ...
    <title>Jasmine Store - Home</title>
  </head>
  <body>
  <header class="header">
    ...
    <div class="row">
      <div class="col-md-6 ">
        <div class="overl">
          ...
          <p>new trend</p>
          <a class="aa" href="shop.php">shop now</a>
        </div>
  ...
  <p>new trend</p>
      ...
      <div class="col-md-6  ">
        <div class="overl1">
          <h2>men</h2>
          <p>new trend</p>
          <a href="shop.php" class="aa" >shop now</a>
        </div>
        <div class="category-data position-relative">
...
<div class="row">
  ...
  <div class="col-lg-3">
    <div class="getintouch text-light my-5">
      ...
      <p >
        Any questions? Let us know go tho the contact page, or call us on 0567067293
      </p>
      <ul class=" d-flex">
